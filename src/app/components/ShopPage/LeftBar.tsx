...
const LeftBar = () => {
  ...
  return (
    <div className="max-w-[300px]">
      <p className="text-2xl font-bold pb-4 pl-6">Filter Option</p>
        ...
        <div className="collapse-content">
          {category.map((item, index) => (
            <div className="flex justify-start items-center cursor-pointer" key={index}>
              <label className="text-lg pl-2 border-2 border-gray-300 rounded-full p-2 mb-2 pr-7">
      ...
      <div className="collapse collapse-arrow border-gray-300 bg-base-100 border-2 m-4">
        <input type="checkbox" />
        <div className="collapse-title text-xl font-medium">Availbility</div>
        <div className="collapse-content">
